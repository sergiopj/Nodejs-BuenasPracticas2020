// seed como concepto de semilla de unos datos determinados que alimentan una app
...
Technology.create(technologies)
  .then(() => {
    console.log("Technologies collection created in db");
    mongoose.disconnect();
  })
  .catch((err) => {
    console.log("Error at create technologies collection in db -- err: ", err);
  });
